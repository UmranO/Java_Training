...
public class Car {
    public String make, model;                        //When I create multiple Car objects I will be able to store
    public int year;                                  //multiple different datas for those attributes of each Car object
    public double price;
    public String color;

                                                     //Different constructors mean diff.options to create the Car object
    ...
    public Car(String make, String model, int year){
        this(make,model);                                            //this.make=make; this.mode=model;
        this.year=year;
    }
