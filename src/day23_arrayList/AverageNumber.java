...
public class AverageNumber {
    public static void main(String[] args){
        ...
        double average = sum / (double)list.size();   //size() will give us the total # of elements in this list.The
        //return type of this size() is int & the return type of this sum is also int
