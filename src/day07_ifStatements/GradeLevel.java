...
2. An integer variable named gradeLevel is declared and given, Write a program to determine and print which school type
   someone is in.
	Ex:
		gradeLevel = 2
	     output:
	...
	13 ~ 16: College
	17 ~ 18: Grad School
      Note: Assume that the given number is between 1 ~ 18  Number is between 1 to 18
 */