...
public class NetIncomeCalculation {
    public static void main(String[] args){
        ...
        double netIncome = salary - totalTax;  // double netIncome=salary(1-taxRate);
...
/*
3. Create a class named NetIncomeCalc, Write a program that can calculate the salary after tax based on the following
   requirements
                the tax rates are:
