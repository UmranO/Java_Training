...
// 1. Print the name and Job Title of every employee
            for (Employee each: employees){
                System.out.println("Name= "+each.getName()+", JobTitle= "+each.getJobTitle());
            }

// 2. How many developers do we have?
            int count=0;
            for (Employee each:employees){
                if (each instanceof Developer){count++;}
            }
            System.out.println("# of Developers = " + count);
...
// 3. How many testers do we have?
            ...
            System.out.println("# of Testers = " + count);
...
// 4. How many teachers do we have?
            ...
            System.out.println("# of Teachers = " + count);
...
// 5. How many Drivers do we have?
            ...
            for (Employee employee : employees) {
                if(employee instanceof Driver){
                    count++; }
            } System.out.println("# of Drivers = " + count);
